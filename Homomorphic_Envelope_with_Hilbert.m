% function homomorphic_envelope = Homomorphic_Envelope_with_Hilbert(input_signal, sampling_frequency,lpf_frequency)
%
...
A_low = [1,-0.992176700177507];
B_low = [0.00391164991124660,0.00391164991124660];
% [B_low,A_low] = butter(1,2*lpf_frequency/sampling_frequency,'low');
homomorphic_envelope = exp(filter(B_low,A_low,log(abs(hilbert(input_signal)))));
